...
| `local-intent.ts` | lo que se entiende **sin llamar al modelo**: agua, insulina con su tipo dicho, carbos, glucosa. Ante la duda no interpreta, y si sobra algo la frase entera va al modelo |
