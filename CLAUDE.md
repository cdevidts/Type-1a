...
**Actualiza `memory-bank/activeContext.md` y `memory-bank/progress.md` en la
misma corrida que el código**, antes de dar el trabajo por terminado.

- `activeContext.md`: qué cambió el foco, qué se cerró, qué quedó abierto.
- `progress.md`: estado de `pnpm verify`, conteo de tests, módulos del bundle,
  y cualquier deuda o trampa nueva que hayas descubierto.

Una tarea que termina sin actualizar el Memory Bank no está terminada.
